...
WHITE=(255,255,255)# RGB COLOUR CODES#
YELLOW=(255,255,0)
BLUE=(100,149,237)   
RED=(188,39,50)
DARK_GREY=(80,78,81)
...
class Planet:
    ...
    def update_position(self,planets): # to find the force exerted by all the other planets on a planet
        total_fx=total_fy=0
        for planet in planets:
            ...
            total_fx += fx
            total_fy += fy
        self.x_vel += total_fx /self.mass *self.TIMESTEP #F=MA formula
